...
hold off;
% xline(BCE_meetings,':')
legend('ESTR','filtered short rate','y(1) yield')
% xlim([t_y(1),t_y(end)])
...
hold off;
xline(BCE_meetings,':')
legend('ESTR','filtered short rate','2Y yield')
xlim([t_y(1),t_y(end)])
...
%SaveFigureFullScreenPDF(h4,['fit at ', datestr(t_y(t_val))])
...
hold off;
title(['yield at maturity = ', num2str(mat_Estr(1,i),'%.0f'),' years'])
%SaveFigureFullScreenPDF(h5,'Ester Yields to maturity')
...
hold off;
title(['yield at maturity = ', num2str(mat_Euribor(1,i),'%.0f'),' years'])
%SaveFigureFullScreenPDF(h6,'Euribor Yields to maturity')

h7 = figure(7);
subplot(3,3,1)
i = 1;
plot(t_y,yEuribor_model(:,i) - yEster_model(:,i))
hold on;
plot(t_y,yEuribor(:,i)-yEster(:,i),'.r');
legend('Model','observed','Location','NorthWest');
hold off;
title(['yield at maturity = ', num2str(mat(1,i)*div,'%.0f'),' days'])
subplot(3,3,2)
i = 3;
plot(t_y,yEuribor_model(:,i) - yEster_model(:,i))
hold on;
...
plot(t_y,yEuribor(:,i)-yEster(:,i),'.r');
hold off;
title(['yield at maturity = ', num2str(mat(1,i),'%.2f'),' years'])
subplot(3,3,4)
i = 6;
plot(t_y,yEuribor_model(:,i)- yEster_model(:,i))
hold on;
plot(t_y,yEuribor(:,i)-yEster(:,i),'.r');
hold off;
title(['yield at maturity = ', num2str(mat(1,i),'%.1f'),' years'])
subplot(3,3,5)
i = 8;
plot(t_y,yEuribor_model(:,i)- yEster_model(:,i))
hold on;
plot(t_y,yEuribor(:,i)-yEster(:,i),'.r');
hold off;
title(['yield at maturity = ', num2str(mat(1,i),'%.0f'),' year'])
subplot(3,3,6)
i = 9;
plot(t_y,yEuribor_model(:,i)- yEster_model(:,i))
hold on;
plot(t_y,yEuribor(:,i)-yEster(:,i),'.r');
hold off;
title(['yield at maturity = ', num2str(mat(1,i),'%.0f'),' years'])
subplot(3,3,7)
i = 12;
plot(t_y,yEuribor_model(:,i)- yEster_model(:,i))
hold on;
...
hold off;
title(['yield at maturity = ', num2str(mat(1,i),'%.0f'),' years'])
%SaveFigureFullScreenPDF(h7,'Spread Euribor - Ester')


h8 = figure(8);
ind=1;
for i=[1,3,5,6,8,9,12,14,17]
subplot(3,3,ind)
plot(t_y,10^4*(yEuribor_model(:,i) - yEuribor(:,i)))
title([num2str(mat(1,i)*div,'%.0f'),' days'])
ind=ind+1;
end
...
for i=[1,3,5,6,8,9,12,14,17]
subplot(3,3,ind)
plot(t_y,10^4*(yEster_model(:,i) - yEster(:,i)))
title([num2str(mat(1,i)*div,'%.0f'),' days'])
ind=ind+1;
end
...
subplot(2,2,3)
plot(t_y, x_est3, 'b', ...
     t_y, x_est3+1.96 * sqrt(Varx_est3), '-g',...
     t_y, x_est3-1.96 * sqrt(Varx_est3), '-g'); 
title('r');
subplot(2,2,4)
plot(t_y, x_est4, 'b', ...
     t_y, x_est4+1.96 * sqrt(Varx_est4), '-g',...
     t_y, x_est4-1.96 * sqrt(Varx_est4), '-g'); 
title('s');
